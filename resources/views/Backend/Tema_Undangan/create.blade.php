...
<div class="container">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <h4>Tambah Data Tema Undangan</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('tema-undangan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="kode" name="kode" placeholder="Kode tema">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Url</label>
                            <input type="text" class="form-control" id="url" name="url" placeholder="url tema" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="exampleForm21">Thumbnail</label>
