...
<div class="container">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <h4>Tambah Data Basic Feature</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('basic-feature.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3" placeholder="Tulis penjelasan fitur disini">{{old('description')}}</textarea>
                        </div>
                    </div>
                </div>
