...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('basic-feature.update', ['basic_feature'=>$data->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3" placeholder="Tulis penjelasan fitur disini">{!! $data->description !!}</textarea>
                        </div>
                    </div>
                </div>
